...
class Frist extends Group {
    constructor() {
        ...
        var entranceBuilding = new Mesh(entranceBuildingGeometry, materials.brick);
        ...
        var entranceBuildingRoof = new Mesh(entranceBuildingRoofGeometry, materials.brick);
        ...
        var leftEntranceRoof = new Mesh(leftEntranceRoofGeometry, materials.stone);
        ...
        var rightEntranceRoof = new Mesh(rightEntranceRoofGeometry, materials.stone);
        ...
        var entranceBuildingStone = new Mesh(entranceBuildingStoneGeometry, materials.stone);
        ...
        var entranceBuildingDoor = new Mesh(entranceBuildingDoorGeometry, materials.door);
        ...
        var leftBuildingRoof = new Mesh(leftBuildingRoofGeometry, materials.brick);
        ...
        var leftBuildingLeftRoof = new Mesh(leftBuildingLeftRoofGeometry, materials.stone);
        ...
        var leftBuildingRightRoof = new Mesh(leftBuildingRightRoofGeometry, materials.stone);
        ...
        var rightBuildingRoof = new Mesh(rightBuildingRoofGeometry, materials.brick);
        ...
        var rightBuildingLeftRoof = new Mesh(rightBuildingLeftRoofGeometry, materials.stone);
        ...
        var rightBuildingRightRoof = new Mesh(rightBuildingRightRoofGeometry, materials.stone);
